...
public final class RowsLogBuffer {
    ...
    public final Serializable nextValue(final int type, final int meta) {
        return nextValue(type, meta, false, null);
    }
     ...
     * Rows_log_event::print_verbose_one_row
     */
    public final Serializable nextValue(final int type, final int meta, boolean isBinary, String charsetName) {
        ...
        if (fNull) {
            ...
            return fetchValue(type, meta, isBinary, charsetName);
        }
    }
     ...
     */
    final Serializable fetchValue(int type, final int meta, boolean isBinary, String charset) {
        int len = 0;
        ...
        switch (type) {
            ...
            case LogEvent.MYSQL_TYPE_VAR_STRING: {
                ...
                if (isBinary) {
                    ...
                    if ("ucs2".equals(charset)) {
                        value = buffer.getFullString(len, "UnicodeBigUnmarked");
                    } else {
