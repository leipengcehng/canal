...
public final class CanalEntry {
  ...
  public static final class Column extends
    ...
    public com.google.protobuf.ByteString
      ...
      public static final int CHARSETNAME_FIELD_NUMBER = 11;
      private java.lang.Object charSetName_;

      /**
       * <code>optional string charSetName = 11;</code>
       *
       * <pre>
       * *字段名称(忽略大小写)，在mysql中是没有的*
       * </pre>
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000200) == 0x00000200)) {
        output.writeBytes(11, getCharSetBytes());
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000200) == 0x00000200)) {
        size += com.google.protobuf.CodedOutputStream
                .computeBytesSize(11, getCharSetBytes());
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      public com.alibaba.otter.canal.protocol.CanalEntry.Column buildPartial() {
        ...
        result.mysqlType_ = charSetName_;
        if (((from_bitField0_ & 0x00000400) == 0x00000400)) {
          to_bitField0_ |= 0x00000200;
        }
  ...
  bitField0_ |= 0x00000200;
        ...
        return this;
          ...
          public Builder clearCharsetName() {
            ...
            charSetName_ = getDefaultInstance().getName();
            onChanged();
            return this;
          }
