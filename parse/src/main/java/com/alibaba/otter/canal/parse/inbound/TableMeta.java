...
public class TableMeta {
    ...
    public static class FieldMeta {
        ...
        public FieldMeta(String columnName, String columnType, boolean nullable, boolean key, String defaultValue, String columnCharset){
            this.columnName = columnName;
            this.columnType = columnType;
            this.nullable = nullable;
            this.key = key;
        ...
        public String getColumnCharset() { return columnCharset; }

        public void setColumnCharset(String columnCharset) { this.columnCharset = columnCharset; }

        @Override
        public String toString() {
            return "FieldMeta [columnName=" + columnName + ", columnType=" + columnType + ", nullable=" + nullable
                   + ", key=" + key + ", defaultValue=" + defaultValue + ", extra=" + extra + ", unique=" + unique + ", columnCharset=" + columnCharset
                   + "]";
        }
